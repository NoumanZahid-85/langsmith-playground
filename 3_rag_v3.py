# pip install -U langchain langchain-groq langchain-community faiss-cpu pypdf python-dotenv langsmith sentence-transformers
...
def build_vectorstore(splits):
    # Use free local embeddings (all-MiniLM-L6-v2 is fast and good)
...
# Using Groq with the official replacement for the deprecated model
llm = ChatGroq(
    model="llama-3.3-70b-versatile",  # ✅ Official replacement
    temperature=0,
...
def setup_pipeline_and_query(pdf_path: str, question: str):
    ...
    # This LangChain run stays under the same root
