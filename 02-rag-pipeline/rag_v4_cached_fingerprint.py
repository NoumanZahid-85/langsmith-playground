...
def build_vectorstore(splits, embed_model_name: str):
    # Use local embeddings - model_name is the HuggingFace model ID
...
def load_or_build_index(
    ...
    embed_model_name: str = "all-MiniLM-L6-v2",   # <-- default local embedding
...
llm = ChatGroq(
    model="llama-3.3-70b-versatile",   # ✅ official replacement for deprecated model
    temperature=0,
